          ...
          <div class="card-columns">
            ...
            <div class="card" style={sectionStyles}>
              {props.infoclean.login ?
                <div>
                  {
                    <img src={"http://ghchart.rshah.org/"+props.infoclean.login} alt="Github chart" style={gitChartStyle}/>
                  }
                  <br/><a href="https://ghchart.rshah.org/" target="_blank">Source for GitHub Chart API</a>
                </div>
                : null }
            </div>
          </div>
